using Marvin.XmlPatch.Converters;
using Marvin.XmlPatch.Exceptions;
using System;
...
namespace Marvin.XmlPatch.XUnitTest
{
    ...
    public class ObjectAdapterTests
    {
        ...
        public void AddResultsShouldReplace()
        {
            ...
            // create patch
            XmlPatchDocument<SimpleDTO> patchDoc = new XmlPatchDocument<SimpleDTO>();
        ...
        public void AddResultsShouldReplaceWithSerialization()
        {
            ...
            var serializer = new System.Xml.Serialization.XmlSerializer(typeof(XmlPatchDocument<SimpleDTO>));

            StringBuilder sbSerialized = new StringBuilder();
            using (var TextWriter = new StringWriter(sbSerialized))
            {
                serializer.Serialize(TextWriter, patchDoc);
                // var serialized = serializer.Serialize(patchDoc);//JsonConvert.SerializeObject(patchDoc);

            }
            var serialized = sbSerialized.ToString();

            //   var deserialized = serializer.Deserialize(serialized);
            var deserialized = serializer.DeserializeString(serialized);
        ...
        public void AddToGenericList()
        {
            ...
            // create patch
            var patchDoc = new XmlPatchDocument<SimpleDTO>();
        ...
        public void AddToListWithSerialization()
        {
            ...
            /* var serialized = JsonConvert.SerializeObject(patchDoc);
             var deserialized = JsonConvert.DeserializeObject<XmlPatchDocument<SimpleDTO>>(serialized);
             */
            var serializer = new XmlSerializer(typeof(XmlPatchDocument<SimpleDTO>));
            string serialized = serializer.SerializeObject(patchDoc);
            var deserialized = (XmlPatchDocument<SimpleDTO>)serializer.DeserializeString(serialized);// JsonConvert.DeserializeObject<XmlPatchDocument<SimpleDTO>>(serialized);
        ...
        public void AddToListInvalidPositionTooLarge()
        {
            ...
            Assert.Throws<XmlPatchException>(() => { patchDoc.ApplyTo(doc); });
        }
        ...
        public void AddToListInvalidPositionTooLargeWithSerialization()
        {
            ...
            Assert.Throws<XmlPatchException>(() => { deserialized.ApplyTo(doc); });
        }
        ...
        public void SerializationNoEnvelope()
        {
            ...
            var serializer = new XmlSerializer(typeof(XmlPatchDocument<SimpleDTO>));
            var deserialized = (XmlPatchDocument<SimpleDTO>)serializer.DeserializeString(patch);// JsonConvert.DeserializeObject<XmlPatchDocument<SimpleDTO>>(serialized);


            //var deserialized = JsonConvert.DeserializeObject<XmlPatchDocument<SimpleDTO>>(patch);
            deserialized.ApplyTo(doc);
        ...
        public void DeserializationMustWorkWithoutEnvelope()
        {
            ...
            var serializer = new XmlSerializer(typeof(XmlPatchDocument<SimpleDTO>));
            string serialized = serializer.SerializeObject(patchDoc);
            var deserialized = (XmlPatchDocument<SimpleDTO>)serializer.DeserializeString(serialized);

            Assert.IsType<XmlPatchDocument<SimpleDTO>>(deserialized);
        ...
        public void DeserializationMustFailWithEnvelope()
        {
            ...
            Assert.Throws<XmlPatchException>(() =>
            {
               
                var deserialized
                    = (XmlPatchDocument<SimpleDTO>)serializer.DeserializeString(serialized);// JsonConvert.DeserializeObject<XmlPatchDocument<SimpleDTO>>(serialized);
            });
        ...
        public void SerializeAndReplaceNestedObjectTest()
        {
            ...
            // create patch
            XmlPatchDocument<SimpleDTOWithNestedDTO> patchDoc = new XmlPatchDocument<SimpleDTOWithNestedDTO>();
            ...
            /* var serialized = JsonConvert.SerializeObject(patchDoc);
               var deserialized = JsonConvert.DeserializeObject<XmlPatchDocument<SimpleDTO>>(serialized);
               */
            var serializer = new XmlSerializer(typeof(XmlPatchDocument<SimpleDTOWithNestedDTO>));
            string serialized = serializer.SerializeObject(patchDoc);
            var deserialized = (XmlPatchDocument<SimpleDTOWithNestedDTO>)serializer.DeserializeString(serialized);
