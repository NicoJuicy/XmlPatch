...
using Mvc.XmlPatch.Converters;
using Mvc.XmlPatch.Helpers;
...
// when producing a XmlPatchDocument.  However, we cannot send this "typed" over the wire, as that would require
// including type data in the XmlPatchDocument serialized as JSON (to allow for correct deserialization) - that's
// not according to RFC 6902, and would thus break cross-platform compatibility. 

namespace Mvc.XmlPatch
{  
    //[JsonConverter(typeof(TypedXmlPatchDocumentConverter))]
  //  [System.Xml.Serialization.XmlElement(typeof(TypedXmlPatchDocumentConverter))]
    //[System.Xml.Serialization.XmlElement(typeof(TypedXmlPatchDocumentConverter))]
   
    [DataContract(Name="PatchDocument",Namespace="",IsReference=false)]
    [XmlRoot(ElementName="PatchDocument",IsNullable=false,Namespace="")]
    public class XmlPatchDocument<T>: IXmlPatchDocument where T:class 
    {
        [XmlArray(ElementName="Operations",IsNullable=false,Namespace="")]
        [XmlArrayItem(ElementName="Operation",IsNullable=false,Namespace="")]
         public List<Operation<T>> Operations { get; private set; }
 
        public XmlPatchDocument()
        {
            Operations = new List<Operation<T>>();
        }

        // Create from list of operations  
        public XmlPatchDocument(List<Operation<T>> operations)
        {
        ...
        /// <returns></returns>
        public XmlPatchDocument<T> Add<TProp>(Expression<Func<T, TProp>> path, TProp value)
        {
        ...
        /// <returns></returns>
        public XmlPatchDocument<T> Add<TProp>(Expression<Func<T, IList<TProp>>> path, TProp value, int position)
        {
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public XmlPatchDocument<T> Add<TProp>(Expression<Func<T, IList<TProp>>> path, TProp value)
        {
        ...
        /// <returns></returns>
        public XmlPatchDocument<T> Remove<TProp>(Expression<Func<T, TProp>> path)
        {
        ...
        /// <param name="position">position</param>
        /// <returns></returns>
        public XmlPatchDocument<T> Remove<TProp>(Expression<Func<T, IList<TProp>>> path, int position)
        {
        ...
        /// <param name="path">target location</param>
        /// <returns></returns>
        public XmlPatchDocument<T> Remove<TProp>(Expression<Func<T, IList<TProp>>> path)
        {
        ...
        /// <returns></returns>
        public XmlPatchDocument<T> Replace<TProp>(Expression<Func<T, TProp>> path, TProp value)
        {
        ...
        /// <param name="position">position</param>
        /// <returns></returns>
        public XmlPatchDocument<T> Replace<TProp>(Expression<Func<T, IList<TProp>>> path,  TProp value, int position)
        {
        ...
        /// <param name="path">target location</param>
        /// <returns></returns>
        public XmlPatchDocument<T> Replace<TProp>(Expression<Func<T, IList<TProp>>> path, TProp value)
        {
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Move<TProp>(Expression<Func<T, TProp>> from, Expression<Func<T, TProp>> path)
        {
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Move<TProp>(Expression<Func<T, IList<TProp>>> from, int positionFrom, Expression<Func<T, TProp>> path)
        {
            Operations.Add(new Operation<T>("move", ExpressionHelpers.GetPath<T, TProp>(path).ToLowerInvariant()
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Move<TProp>(Expression<Func<T, TProp>> from,
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Move<TProp>(Expression<Func<T, IList<TProp>>> from, int positionFrom,
            Expression<Func<T, IList<TProp>>> path, int positionTo)
        {
            Operations.Add(new Operation<T>("move", ExpressionHelpers.GetPath<T, IList<TProp>>(path).ToLowerInvariant()
                + "/" + positionTo
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Move<TProp>(Expression<Func<T, TProp>> from, Expression<Func<T, IList<TProp>>> path)
        {
            Operations.Add(new Operation<T>("move", ExpressionHelpers.GetPath<T, IList<TProp>>(path).ToLowerInvariant() + "/-"
              , ExpressionHelpers.GetPath<T, TProp>(from).ToLowerInvariant()));
            return this;
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Copy<TProp>(Expression<Func<T, TProp>> from, Expression<Func<T, TProp>> path)
        {
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Copy<TProp>(Expression<Func<T, IList<TProp>>> from, int positionFrom, Expression<Func<T, TProp>> path)
        {
            Operations.Add(new Operation<T>("copy", ExpressionHelpers.GetPath<T, TProp>(path).ToLowerInvariant()
              , ExpressionHelpers.GetPath<T, IList<TProp>>(from).ToLowerInvariant() + "/" + positionFrom));
            return this;
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Copy<TProp>(Expression<Func<T, TProp>> from, 
            Expression<Func<T, IList<TProp>>> path,  int positionTo)
        {
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Copy<TProp>(Expression<Func<T, IList<TProp>>> from, int positionFrom, 
            Expression<Func<T, IList<TProp>>> path, int positionTo)
        {
            Operations.Add(new Operation<T>("copy", ExpressionHelpers.GetPath<T, IList<TProp>>(path).ToLowerInvariant() 
                + "/" + positionTo
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public XmlPatchDocument<T> Copy<TProp>(Expression<Func<T, TProp>> from, Expression<Func<T, IList<TProp>>> path)
        {
            Operations.Add(new Operation<T>("copy", ExpressionHelpers.GetPath<T, IList<TProp>>(path).ToLowerInvariant() + "/-"
              , ExpressionHelpers.GetPath<T, TProp>(from).ToLowerInvariant()));
            return this;
        ...
        /// </summary>
        /// <param name="objectToApplyTo">The object to apply the XmlPatchDocument to</param>
        ...
        IList<Operation> IXmlPatchDocument.GetOperations()
        {
